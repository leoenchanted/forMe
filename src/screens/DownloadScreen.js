...
const styles = StyleSheet.create({
  ...
  card: { flexDirection: 'row', backgroundColor: '#fff', padding: 12, borderRadius: 16, marginBottom: 16, elevation: 2, alignItems: 'center' },
  ...
  cancelBtn: { padding: 8, backgroundColor: '#fef2f2', borderRadius: 20, marginLeft: 8 },
